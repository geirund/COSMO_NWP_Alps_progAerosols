# compiler
F90      = mpif90-mpich-mp -D__GNU_FORTRAN__
...
# Grib1 library
GRIBDWDL = -L/usr/local/cosmo/libgrib1_gnu4.8.2 -lgrib1
GRIBDWDI = 

# Grib-API library
GRIBAPIL = -L/usr/local/cosmo/libgrib_api_1.11.0.1_gnu4.8.2/lib -lgrib_api_f90 -lgrib_api -L/usr/local/cosmo/libjasper_1.900.1_gnu4.8.2/lib -ljasper
GRIBAPII = -I/usr/local/cosmo/libgrib_api_1.11.0.1_gnu4.8.2/include

# NetCDF library
NETCDFL  = -L/opt/local/lib -lnetcdf -lnetcdff
NETCDFI  = -I/opt/local/include

# Synsat library
RTTOV7L  = -L/usr/local/cosmo/librttov7_gnu4.8.2 -lrttov7
RTTOV7I  = 
RTTOV10L = 
RTTOV10I = 
