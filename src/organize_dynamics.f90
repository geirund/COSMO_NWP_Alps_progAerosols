...
USE data_runcontrol,     ONLY:  lsemi_imp, l2tls, lrubc, lspubc, rdheight,    &
                                ...
                                divdamp_slope, l_diff_cold_pools
...
!------------------------------------------------------------------------------
  ...
  divdamp_slope_d = 20.0_wp
  l_diff_cold_pools_d = .FALSE.
...
IF (nproc > 1) THEN
  ...
  CALL distribute_values (logbuf , 19, 0, imp_logical,   icomm_world, ierr)
