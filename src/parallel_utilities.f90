...
!  Introduced dp/sp as KIND parameters instead of wp/irealgrib
...
! allocate send/receive buffers
  ...
  ALLOCATE (rsendbuf(INT(nlev*SUM(icount_distr)/2_iintegers+0.01_wp)),  &
                                                              STAT=izlocstat)
  istat = istat + izlocstat
  ALLOCATE (rrecvbuf(INT(nlev*SUM(icount_order)/2_iintegers+0.01_wp)),  &
                                                              STAT=izlocstat)
  istat = istat + izlocstat
...
!------------------------------------------------------------------------------
  ...
  icount_order = INT(icount_order * nlev / 2_iintegers + 0.01_wp)
  idispl_order = INT(idispl_order * nlev / 2_iintegers + 0.01_wp)
  icount_distr = INT(icount_distr * nlev / 2_iintegers + 0.01_wp)
  idispl_distr = INT(idispl_distr * nlev / 2_iintegers + 0.01_wp)
