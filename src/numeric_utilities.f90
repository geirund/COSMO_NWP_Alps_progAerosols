    ...
    DO j=2, je-1
      DO i=2, ie-1
        ...
        dv1_dzeta = ( ( v1(i,j,k+1) + v1(i-1,j,k+1) )                   &
          &         - ( v1(i,j,k-1) + v1(i-1,j,k-1) ) ) * 0.25_wp
        ...
        dv2_dzeta = ( ( v2(i,j,k+1) + v2(i,j-1,k+1) )                   &
          &         - ( v2(i,j,k-1) + v2(i,j-1,k-1) ) ) * 0.25_wp
...
!------------------------------------------------------------------------------
  ...
  DO j = jstart-1, jend+1
    DO i = istart-1, iend+1
      ...
      zdx(i,j) = zdql * MAX(0.0_wp,                                   &
                 MIN(2.0_wp, 2.0_wp*zr, 0.5_wp*(1.0_wp+zr)))
      zdql     = zsx(i,j  ) - zsx(i,j-1)
      zdqr     = zsx(i,j+1) - zsx(i,j  )
      zr       = zdqr / (zdql + eps_div)
      zdy(i,j) = zdql * MAX(0.0_wp,                                   &
                 MIN(2.0_wp, 2._wp*zr, 0.50_wp*(1.0_wp+zr)))
    ENDDO
  ENDDO
...
DO j=1, je
  DO i=1, ie
    ...
    s_halo(i,j,-2) = 0.0_wp !_wp
    s_halo(i,j,-3) = 0.0_wp !_wp
    s_halo(i,j,-4) = 0.0_wp !_wp
    s_halo(i,j,-5) = 0.0_wp !_wp
