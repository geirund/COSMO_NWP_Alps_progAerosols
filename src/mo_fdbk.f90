...
!
! $Id: mo_fdbk.f90,v 4.29 2013-10-04 08:51:39 for0adm Exp $
!-------------------------------------------------------------------------------
!
MODULE mo_fdbk
!
...
type t_fdbk_meta
  ...
  real                :: resolution (2) =  0.0_wp ! model resolution (x,y)
...
!------------------------------------------------------------------------------
  ...
  type (t_fdbk), intent(inout) :: fb
    ...
    if (any(fb% pole /= 0.0 .or. fb% lower_left /= 0.0 .or. fb% upper_right /= 0.0)) then
