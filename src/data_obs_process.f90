...
!                 -----------------------------------------
  ...
  REAL    (KIND=wp)        , PARAMETER  :: &
    atol   =  0.0001_wp  ! area tolerance (because of rounding off problem)
 
  REAL    (KIND=wp)        , PARAMETER  :: &
                             ! scaling factors
    rfact (16) = (/    10._wp,  1.0_wp,  1.0_wp,  0.1_wp,      &
!                          PP           U            V            TT    
                       0.1_wp,  10._wp,  1.0_wp,  1.0_wp,      &
!                          TDT          RPT          ZZ           DZ  
                       1.0_wp,  1.0_wp,  10._wp,  1.0_wp,      &
!                          WW           CL           RLP          QQ
                       0.1_wp,  0.01_wp, 0.1_wp,  1.0_wp/)
!                          STT          SNW          RR           TR
...
!                 -----------------------------------
  ...
  REAL    (KIND=wp)        , PARAMETER  :: &
    ...
    rpset  (12) = (/    0._wp,    0._wp, 8500._wp, 7000._wp,   &
                        0._wp,    0._wp,    0._wp,    0._wp,   &
                        0._wp, 9000._wp,10000._wp, 5000._wp/) ,&
                  ! values of geopotential for different pressure codes
    rzset  (12) = (/    0._wp,    0._wp,    0._wp,    0._wp,   &
                      500._wp, 1000._wp, 2000._wp, 3000._wp,   &
                     4000._wp,    0._wp,    0._wp,    0._wp/)
