...
CHARACTER (LEN=*), PARAMETER :: INFO_CompilerVersion = 'pgf90 18.5-0 64-bit target on x86-64 Linux -tp ' // &
    'haswell-64'
CHARACTER (LEN=*), PARAMETER :: INFO_DefinedMacros = '-I. -I/users/dedekind/code/yves_gesa_inp_ccn/src ' // &
    '-I/opt/cray/pe/mpt/7.7.2/gni/mpich-pgi/15.3/include -I/project/s799/geirund/software/lib -D__MPICH2'
CHARACTER (LEN=*), PARAMETER :: INFO_UndefinedMacros = '(missing)'
CHARACTER (LEN=*), PARAMETER :: INFO_DebugOptions = '(missing)'
CHARACTER (LEN=*), PARAMETER :: INFO_LinkOptions = 'ftn -D__PGI_FORTRAN__ -L/project/s799/geirund/software/lib -lifs_pgi ' // &
...
CHARACTER (LEN=*), PARAMETER :: INFO_CompileTime = 'Sun Jul  7 22:41:27 CEST 2019'
